...
const Building2 = createLucideIcon("building-2", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-gradient-to-b from-background to-secondary/20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "relative bg-primary text-primary-foreground shadow-lg overflow-hidden animate-slide-in-right", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative z-10 py-8 md:py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-5xl font-bold tracking-tight", children: "Ghuge Medicals Pharmaceutical Distributors" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-primary-foreground/90 mt-1", children: "Serving Madha Taluka" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 container py-8 md:py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:gap-8 lg:grid-cols-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-lg border-2 hover:shadow-xl transition-shadow animate-slide-in-right-delay-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold text-foreground mb-6 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-6 h-6 text-accent" }),
            "Business Hours"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-accent/10 rounded-lg p-5 border-l-4 border-accent mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-muted-foreground uppercase tracking-wide mb-1", children: "Monday – Saturday" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-accent", children: "10:00 AM – 8:00 PM" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent text-accent-foreground text-sm px-3 py-1", children: "Open" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 bg-warning/10 border border-warning/30 rounded-lg p-4 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5 text-warning flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "Sunday — Hours Not Fixed" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Sunday availability may vary. Please call ahead to confirm we are open before visiting." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 border border-primary/20 rounded-xl p-5 flex flex-col sm:flex-row items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-base", children: "Not sure if we're open?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Give us a call — especially for Sunday availability." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PHONE_NUMBER}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-lg border-2 hover:shadow-xl transition-shadow animate-slide-in-right-delay-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-foreground mb-6", children: "Contact Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 p-4 rounded-lg bg-secondary/50 hover:bg-secondary transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-6 h-6 text-accent flex-shrink-0 mt-1" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 p-4 rounded-lg bg-secondary/50 hover:bg-secondary transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-6 h-6 text-accent flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-1", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: "aghuge99@gmail.com"
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 p-4 rounded-lg bg-secondary/50 hover:bg-secondary transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-6 h-6 text-accent flex-shrink-0 mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-1", children: "Location" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "flex-1 min-w-[140px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${PHONE_NUMBER}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:aghuge99@gmail.com", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-6 md:mt-8 shadow-lg border-2 animate-slide-in-right-delay-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-primary/10 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-8 h-8 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-foreground mb-2", children: "Business Information" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-semibold text-foreground mb-2 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-accent" }),
                "Complete Address"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/30 rounded-lg p-4 border-l-4 border-primary", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium", children: "Ghuge Medicals" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Choriya Township Bypass Road" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Kurduwadi, Maharashtra" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-semibold", children: "PIN: 413208" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-foreground mb-2", children: "Location Details" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent/10 rounded-lg p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-1", children: "Coordinates" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-mono text-sm", children: "17.8805°N, 75.4148°E" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-foreground mb-2", children: "About Our Store" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-secondary/30 rounded-lg p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Ghuge Medicals is a trusted pharmaceutical distributor serving the Kurduwadi region and surrounding areas. We specialize in providing quality medical supplies, healthcare products, and pharmaceutical items to meet the healthcare needs of our community." }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-foreground mb-2", children: "Services Offered" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Medical Supplies" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Healthcare Products" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Pharmaceutical Items" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: "Medical Equipment" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "my-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-center justify-between bg-primary/5 rounded-lg p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center sm:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Need directions?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold", children: "Visit us on Google Maps" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-6 md:mt-8 shadow-lg border-2 bg-white animate-slide-in-right-delay-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 md:p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-accent/10 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stethoscope, { className: "w-7 h-7 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent", children: "Our Pharmaceutical Partners" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-4 text-sm", children: "We proudly distribute products from these trusted pharmaceutical companies." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: partnerLogoImages.map((img) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-6 md:mt-8 shadow-lg border-2 animate-slide-in-right-delay-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-foreground mb-4", children: "About Ghuge Medicals" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-muted-foreground leading-relaxed", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-primary bg-yellow-100 px-1 rounded", children: "We have nearly 20 years of experience" }),
          " ",
          "in providing quality medical supplies and pharmaceutical products to our community. Our mission is to maintain the health of Madha Taluka. Visit us at our convenient location on Choriya Township Bypass Road, Kurduwadi, or contact us for any inquiries about our services."
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground mt-auto animate-slide-in-right-delay-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Ghuge Medicals Pharmaceutical Distributors" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/80", children: "Maintaining the Health of Madha Taluka" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-right text-sm text-primary-foreground/80", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          currentYear,
          " Ghuge Medicals. All rights reserved."
        ] }),
