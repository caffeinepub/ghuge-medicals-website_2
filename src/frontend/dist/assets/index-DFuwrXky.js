...
function SectionDivider({ label }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 my-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground px-2", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
  ] });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-gradient-to-b from-background to-secondary/20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        style: {
          background: "linear-gradient(135deg, oklch(0.88 0.07 240) 0%, oklch(0.90 0.07 200) 40%, oklch(0.92 0.06 155) 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-8", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              width: "100%",
              height: "100%",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "pattern",
                    {
                      ...
                      height: "30",
                      patternUnits: "userSpaceOnUse",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "15", cy: "15", r: "2", fill: "oklch(0.55 0.10 200)" })
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container relative z-10 py-10 md:py-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
                className: "text-3xl md:text-5xl font-bold tracking-tight drop-shadow-sm",
                style: { color: "oklch(0.20 0.10 240)" },
                children: "Ghuge Medicals Pharmaceutical Distributors"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 container py-8 md:py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-lg border-2 animate-slide-in-right-delay-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-muted-foreground leading-relaxed", children: [
          ...
          " ",
          "in providing quality medical supplies and pharmaceutical products to our community. Visit us at our convenient location on Choriya Township Bypass Road, Kurduwadi, or contact us for any inquiries about our services."
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, { label: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-lg border-2 hover:shadow-xl transition-shadow animate-slide-in-right-delay-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "mt-6 md:mt-8 shadow-lg border-2 animate-slide-in-right-delay-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionDivider, { label: "Our Partners" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-lg border-2 bg-primary/5 animate-slide-in-right-delay-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 md:p-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6 text-sm", children: "We proudly distribute products from these trusted pharmaceutical companies." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: partnerLogoImages.map((img) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-48 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: img.src,
                  alt: img.alt,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-center text-muted-foreground tracking-wide uppercase", children: img.label })
            ]
          },
          img.src
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "oklch(0.38 0.10 220)" }, children: "Maintaining the Health of Madha Taluka" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
